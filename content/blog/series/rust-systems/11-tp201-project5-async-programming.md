...
**Goals**:
- Understand the async programming model in Rust
- Use tokio as the async runtime
- Rewrite networking layer with async I/O
- Compare performance of async vs threaded approaches

## Building Blocks 5 (pre-reading)

Topics: Async I/O, futures, tokio, async/await patterns.
