...
**Tasks**:
- Project 1: Understand SQL and relational algebra fundamentals
- Project 2: Implement a SQL parser (text → AST)

TinySQL is the SQL layer that sits on top of TinyKV. Together they form a complete distributed relational database (similar to TiDB + TiKV).
